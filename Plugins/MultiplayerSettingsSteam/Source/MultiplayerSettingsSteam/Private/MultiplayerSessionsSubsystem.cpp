...
void UMultiplayerSessionsSubsystem::CreateSession(int32 NumPublicConnections, FString MatchType)
{
	...
	LastSessionSettings->BuildUniqueId = 1;// For other people to host
...
void UMultiplayerSessionsSubsystem::OnFindSessionsComplete(bool wasSuccessful)
{
	...
	{
		MultiplayerOnFindSessionsComplete.Broadcast(LastSessionSearch->SearchResults, wasSuccessful);		
	}
...
void UMultiplayerSessionsSubsystem::OnDestroySessionComplete(FName SessionName, bool wasSuccessful)
{
	...
	if (wasSuccessful && CreateSessionOnDestroy)
	{
...
void UMultiplayerSessionsSubsystem::OnStartSessionComplete(FName SessionName, bool wasSuccessful)
{
}
